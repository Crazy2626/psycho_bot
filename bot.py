...
def get_compatibility(date1: str, date2: str, premium: bool = False) -> dict:
    try:
        ...
        return {"percent": 50, "text": "❌ Ошибка в расчёте. Попробуйте ещё раз.", "sign1": "?", "sign2": "?"}
