...
def get_compatibility(date1: str, date2: str, premium: bool = False) -> dict:
    try:
        ...
        desc_key = (elem1, elem2) if (elem1, elem2) in [
            ("Огонь 🔥", "Огонь 🔥"), ("Огонь 🔥", "Воздух 💨"), ("Земля 🌍", "Земля 🌍"),
            ("Земля 🌍", "Вода 💧"), ("Вода 💧", "Вода 💧"), ("Воздух 💨", "Воздух 💨"),
            ("Вода 💧", "Воздух 💨")
        ] else (elem2, elem1)
        
        descriptions = {
            ("Огонь 🔥", "Огонь 🔥"): {
                "range": (88, 98), "text": "🌟 *Стихия Огня + Огонь* — страсть зашкаливает! Вы — два факела, которые вместе горят ярче. 💕",
                "strengths": "• Взаимное вдохновение и поддержка\n• Страстные и яркие отношения\n• Много энергии для совместных целей",
                "weaknesses": "• Конкуренция и борьба за лидерство\n• Склонность к конфликтам\n• Быстрое выгорание",
                "advice": "Учитесь уступать и договариваться. Ваша сила — в союзе, а не в соперничестве. 🤝",
                "karma": "Научиться ценить вклад партнёра и делить победы",
                "future": "Яркие, насыщенные отношения с потенциалом перерасти в мощный творческий союз"
            },
            ("Огонь 🔥", "Воздух 💨"): {
                "range": (82, 94), "text": "💫 *Огонь + Воздух* — взрывная смесь страсти и свободы! Вы будете вдохновлять друг друга. 🚀",
                "strengths": "• Искра между вами никогда не гаснет\n• Легкость и свобода в отношениях\n• Взаимное вдохновение",
                "weaknesses": "• Нестабильность и непредсказуемость\n• Отсутствие глубины\n• Склонность к изменам",
                "advice": "Балансируйте между свободой и обязательствами. Добавьте в отношения немного стабильности. ⚖️",
                "karma": "Научиться превращать искру в стабильный огонь",
                "future": "Яркий роман, который может перерасти в нечто большее, если работать над стабильностью"
            },
            ("Земля 🌍", "Земля 🌍"): {
                "range": (85, 95), "text": "🌱 *Земля + Земля* — вы созданы друг для друга! Крепкий, надёжный и стабильный союз. 🏡",
                "strengths": "• Надёжность и стабильность\n• Общие ценности и цели\n• Умение строить совместное будущее",
                "weaknesses": "• Скука и рутина\n• Недостаток романтики и спонтанности\n• Упрямство",
                "advice": "Добавьте в отношения немного лёгкости и спонтанности. Устраивайте романтические сюрпризы. 🎁",
                "karma": "Научиться строить не только материальный, но и эмоциональный мир",
                "future": "Крепкий брак, общий дом, стабильность и достаток"
            },
            ("Земля 🌍", "Вода 💧"): {
                "range": (85, 97), "text": "🌸 *Земля + Вода* — идеальная гармония! Земля даёт форму, Вода наполняет смыслом. 💧",
                "strengths": "• Глубокое взаимопонимание\n• Уют, забота и внимание\n• Совместное созидание",
                "weaknesses": "• Зависимость друг от друга\n• Склонность к замыканию в паре\n• Медлительность",
                "advice": "Не теряйте связь с внешним миром. Общайтесь с друзьями, путешествуйте. 🌍",
                "karma": "Научиться питать друг друга, не растворяясь друг в друге",
                "future": "Гармоничная семья, где ценят традиции и чувства"
            },
            ("Вода 💧", "Вода 💧"): {
                "range": (90, 98), "text": "🌊 *Вода + Вода* — глубинная связь душ! Вы чувствуете друг друга без слов. 💕",
                "strengths": "• Эмпатия и взаимопонимание\n• Эмоциональная близость\n• Интуитивная связь",
                "weaknesses": "• Эмоциональные качели\n• Замкнутость на проблемах\n• Обидчивость",
                "advice": "Работайте над эмоциональной устойчивостью. Учитесь выходить из кризисов вместе. 💪",
                "karma": "Научиться управлять океаном эмоций, не утонув в нём",
                "future": "Душевные, глубокие отношения, полные понимания и эмпатии"
            },
            ("Воздух 💨", "Воздух 💨"): {
                "range": (75, 88), "text": "💬 *Воздух + Воздух* — лёгкость и свобода! Вам никогда не бывает скучно вместе. 🦋",
                "strengths": "• Интеллектуальное взаимопонимание\n• Много общих тем и интересов\n• Лёгкость и свобода",
                "weaknesses": "• Недостаток глубины чувств\n• Легкомыслие в обязательствах\n• Избегание серьёзных разговоров",
                "advice": "Не бойтесь глубины. Открывайте друг другу душу и чувства. 💕",
                "karma": "Научиться переводить интеллектуальную связь в эмоциональную",
                "future": "Союз друзей-единомышленников, но потребует усилий для создания семьи"
            },
            ("Вода 💧", "Воздух 💨"): {
                "range": (65, 80), "text": "🌿 *Вода + Воздух* — интересный союз. Эмоции встречаются с разумом. 🕊️",
                "strengths": "• Баланс чувств и логики\n• Умение слушать и слышать\n• Интерес к миру друг друга",
                "weaknesses": "• Вода слишком эмоциональна для Воздуха\n• Воздух слишком холоден для Воды\n• Непонимание",
                "advice": "Учитесь принимать различия. Ваша уникальность может стать силой. 🌈",
                "karma": "Научиться понимать язык друг друга (чувств и логики)",
                "future": "Отношения-вызов, но именно в этом их сила и интерес"
            }
        }
        desc = descriptions.get(desc_key, descriptions[("Огонь 🔥", "Огонь 🔥")])
        compatibility = random.randint(desc["range"][0], desc["range"][1])
        base_text = f"{desc['text']}\n\n💪 *Сильные стороны:*\n{desc['strengths']}\n\n⚠️ *Точки роста:*\n{desc['weaknesses']}\n\n💫 *Совет:*\n{desc['advice']}"
        if premium:
            additional = f"\n\n✨ *Кармическая задача пары:* {desc['karma']}\n🔮 *Прогноз развития:* {desc['future']}"
        else:
        ...
        return {"percent": 0, "text": "❌ Ошибка формата даты. Проверьте правильность ввода ДД.ММ.ГГГГ"}
