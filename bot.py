...
# ========== ИСПРАВЛЕННАЯ ФУНКЦИЯ СОВМЕСТИМОСТИ ==========
def get_compatibility(date1: str, date2: str, premium: bool = False) -> dict:
    try:
        ...
        # ПРАВИЛЬНЫЕ СТИХИИ ЗНАКОВ ЗОДИАКА
        elements = {
        ...
        compat_table = {
            ("Огонь 🔥", "Огонь 🔥"): (88, 98, "🌟 *Огонь + Огонь* — страсть зашкаливает! Вы — два факела, которые вместе горят ярче. 🔥\n\n💪 *Сильные стороны:*\n• Взаимное вдохновение и поддержка\n• Страстные и яркие отношения\n• Много энергии для совместных целей\n\n⚠️ *Точки роста:*\n• Конкуренция и борьба за лидерство\n• Склонность к конфликтам\n• Быстрое выгорание\n\n💫 *Совет:* Учитесь уступать и договариваться. Ваша сила — в союзе, а не в соперничестве. 🤝"),
            ("Огонь 🔥", "Воздух 💨"): (85, 95, "💫 *Огонь + Воздух* — взрывная смесь страсти и свободы! Вы будете вдохновлять друг друга. 🚀\n\n💪 *Сильные стороны:*\n• Искра между вами никогда не гаснет\n• Легкость и свобода в отношениях\n• Взаимное вдохновение\n\n⚠️ *Точки роста:*\n• Нестабильность и непредсказуемость\n• Отсутствие глубины\n• Склонность к изменам\n\n💫 *Совет:* Балансируйте между свободой и обязательствами. Добавьте в отношения немного стабильности. ⚖️"),
            ("Воздух 💨", "Огонь 🔥"): (85, 95, "💫 *Воздух + Огонь* — взрывная смесь свободы и страсти! Вы будете вдохновлять друг друга. 🚀\n\n💪 *Сильные стороны:*\n• Искра между вами никогда не гаснет\n• Легкость и свобода в отношениях\n• Взаимное вдохновение\n\n⚠️ *Точки роста:*\n• Нестабильность и непредсказуемость\n• Отсутствие глубины\n• Склонность к изменам\n\n💫 *Совет:* Балансируйте между свободой и обязательствами. Добавьте в отношения немного стабильности. ⚖️"),
            ("Земля 🌍", "Земля 🌍"): (90, 98, "🌱 *Земля + Земля* — вы созданы друг для друга! Крепкий, надёжный и стабильный союз. 🏡\n\n💪 *Сильные стороны:*\n• Надёжность и стабильность\n• Общие ценности и цели\n• Умение строить совместное будущее\n\n⚠️ *Точки роста:*\n• Скука и рутина\n• Недостаток романтики и спонтанности\n• Упрямство\n\n💫 *Совет:* Добавьте в отношения немного лёгкости и спонтанности. Устраивайте романтические сюрпризы. 🎁"),
            ("Земля 🌍", "Вода 💧"): (90, 97, "🌸 *Земля + Вода* — идеальная гармония! Земля даёт форму, Вода наполняет смыслом. 💧\n\n💪 *Сильные стороны:*\n• Глубокое взаимопонимание\n• Уют, забота и внимание\n• Совместное созидание\n\n⚠️ *Точки роста:*\n• Зависимость друг от друга\n• Склонность к замыканию в паре\n• Медлительность\n\n💫 *Совет:* Не теряйте связь с внешним миром. Общайтесь с друзьями, путешествуйте. 🌍"),
            ("Вода 💧", "Земля 🌍"): (90, 97, "🌸 *Вода + Земля* — идеальная гармония! Вода наполняет смыслом, Земля даёт форму. 💧\n\n💪 *Сильные стороны:*\n• Глубокое взаимопонимание\n• Уют, забота и внимание\n• Совместное созидание\n\n⚠️ *Точки роста:*\n• Зависимость друг от друга\n• Склонность к замыканию в паре\n• Медлительность\n\n💫 *Совет:* Не теряйте связь с внешним миром. Общайтесь с друзьями, путешествуйте. 🌍"),
            ("Вода 💧", "Вода 💧"): (85, 98, "🌊 *Вода + Вода* — глубинная связь душ! Вы чувствуете друг друга без слова. 💕\n\n💪 *Сильные стороны:*\n• Эмпатия и взаимопонимание\n• Эмоциональная близость\n• Интуитивная связь\n\n⚠️ *Точки роста:*\n• Эмоциональные качели\n• Замкнутость на проблемах\n• Обидчивость\n\n💫 *Совет:* Работайте над эмоциональной устойчивостью. Учитесь выходить из кризисов вместе. 💪"),
            ("Воздух 💨", "Воздух 💨"): (75, 88, "💬 *Воздух + Воздух* — лёгкость и свобода! Вам никогда не бывает скучно вместе. 🦋\n\n💪 *Сильные стороны:*\n• Интеллектуальное взаимопонимание\n• Много общих тем и интересов\n• Лёгкость и свобода\n\n⚠️ *Точки роста:*\n• Недостаток глубины чувств\n• Легкомыслие в обязательствах\n• Избегание серьёзных разговоров\n\n💫 *Совет:* Не бойтесь глубины. Открывайте друг другу душу и чувства. 💕"),
            ("Вода 💧", "Воздух 💨"): (60, 75, "🌿 *Вода + Воздух* — интересный союз. Эмоции встречаются с разумом. 🕊️\n\n💪 *Сильные стороны:*\n• Баланс чувств и логики\n• Умение слушать и слышать\n• Интерес к миру друг друга\n\n⚠️ *Точки роста:*\n• Вода слишком эмоциональна для Воздуха\n• Воздух слишком холоден для Воды\n• Непонимание\n\n💫 *Совет:* Учитесь принимать различия. Ваша уникальность может стать силой. 🌈"),
            ("Воздух 💨", "Вода 💧"): (60, 75, "🌿 *Воздух + Вода* — интересный союз. Разум встречается с эмоциями. 🕊️\n\n💪 *Сильные стороны:*\n• Баланс чувств и логики\n• Умение слушать и слышать\n• Интерес к миру друг друга\n\n⚠️ *Точки роста:*\n• Воздух слишком холоден для Воды\n• Вода слишком эмоциональна для Воздуха\n• Непонимание\n\n💫 *Совет:* Учитесь принимать различия. Ваша уникальность может стать силой. 🌈"),
            ("Огонь 🔥", "Земля 🌍"): (50, 70, "🔥 *Огонь + Земля* — страсть и стабильность. Вы можете многому научиться друг у друга. 🔥🌍\n\n💪 *Сильные стороны:*\n• Баланс активности и надёжности\n• Возможность роста через различия\n\n⚠️ *Точки роста:*\n• Разные ритмы жизни\n• Непонимание потребностей\n\n💫 *Совет:* Уважайте различия, ищите компромиссы."),
            ("Земля 🌍", "Огонь 🔥"): (50, 70, "🔥 *Земля + Огонь* — стабильность и страсть. Вы можете многому научиться друг у друга. 🌍🔥\n\n💪 *Сильные стороны:*\n• Баланс активности и надёжности\n• Возможность роста через различия\n\n⚠️ *Точки роста:*\n• Разные ритмы жизни\n• Непонимание потребностей\n\n💫 *Совет:* Уважайте различия, ищите компромиссы.")
        }
        ...
        if premium:
            additional = f"\n\n✨ *Кармическая задача пары:* Научиться принимать различия и превращать их в силу.\n🔮 *Прогноз развития:* Ваши отношения имеют все шансы перерасти в нечто большее, если вы будете работать над собой.\n💎 *Premium-бонус:* Полный PDF-отчёт с детальным разбором (12 страниц) доступен в меню!"
        else:
