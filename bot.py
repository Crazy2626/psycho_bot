...
def get_compatibility(date1: str, date2: str, premium: bool = False) -> dict:
    try:
        # Разбираем даты и сразу проверяем формат
        parts1 = date1.split('.')
        parts2 = date2.split('.')
        if len(parts1) != 3 or len(parts2) != 3:
            return {"percent": 0, "text": "❌ Ошибка формата даты. Нужно ДД.ММ.ГГГГ"}

        day1, month1, year1 = map(int, parts1)
        day2, month2, year2 = map(int, parts2)

        # Проверка реальности дат (простая)
        if not (1 <= day1 <= 31 and 1 <= month1 <= 12 and 1000 <= year1 <= 9999):
            return {"percent": 0, "text": "❌ Ошибка: неверная дата (проверьте день, месяц, год)"}
        if not (1 <= day2 <= 31 and 1 <= month2 <= 12 and 1000 <= year2 <= 9999):
            return {"percent": 0, "text": "❌ Ошибка: неверная дата (проверьте день, месяц, год)"}
        ...
        compat_data = {
            ("Огонь 🔥", "Огонь 🔥"): (88, 98, "🌟 *Стихия Огня + Огонь* — страсть зашкаливает! Вы — два факела, которые вместе горят ярче. 💕\n\n💪 *Сильные стороны:*\n• Взаимное вдохновение и поддержка\n• Страстные и яркие отношения\n• Много энергии для совместных целей\n\n⚠️ *Точки роста:*\n• Конкуренция и борьба за лидерство\n• Склонность к конфликтам\n• Быстрое выгорание\n\n💫 *Совет:*\nУчитесь уступать и договариваться. Ваша сила — в союзе, а не в соперничестве. 🤝"),
            ("Огонь 🔥", "Воздух 💨"): (82, 94, "💫 *Огонь + Воздух* — взрывная смесь страсти и свободы! Вы будете вдохновлять друг друга. 🚀\n\n💪 *Сильные стороны:*\n• Искра между вами никогда не гаснет\n• Легкость и свобода в отношениях\n• Взаимное вдохновение\n\n⚠️ *Точки роста:*\n• Нестабильность и непредсказуемость\n• Отсутствие глубины\n• Склонность к изменам\n\n💫 *Совет:*\nБалансируйте между свободой и обязательствами. Добавьте в отношения немного стабильности. ⚖️"),
            ("Земля 🌍", "Земля 🌍"): (85, 95, "🌱 *Земля + Земля* — вы созданы друг для друга! Крепкий, надёжный и стабильный союз. 🏡\n\n💪 *Сильные стороны:*\n• Надёжность и стабильность\n• Общие ценности и цели\n• Умение строить совместное будущее\n\n⚠️ *Точки роста:*\n• Скука и рутина\n• Недостаток романтики и спонтанности\n• Упрямство\n\n💫 *Совет:*\nДобавьте в отношения немного лёгкости и спонтанности. Устраивайте романтические сюрпризы. 🎁"),
            ("Земля 🌍", "Вода 💧"): (85, 97, "🌸 *Земля + Вода* — идеальная гармония! Земля даёт форму, Вода наполняет смыслом. 💧\n\n💪 *Сильные стороны:*\n• Глубокое взаимопонимание\n• Уют, забота и внимание\n• Совместное созидание\n\n⚠️ *Точки роста:*\n• Зависимость друг от друга\n• Склонность к замыканию в паре\n• Медлительность\n\n💫 *Совет:*\nНе теряйте связь с внешним миром. Общайтесь с друзьями, путешествуйте. 🌍"),
            ("Вода 💧", "Вода 💧"): (90, 98, "🌊 *Вода + Вода* — глубинная связь душ! Вы чувствуете друг друга без слов. 💕\n\n💪 *Сильные стороны:*\n• Эмпатия и взаимопонимание\n• Эмоциональная близость\n• Интуитивная связь\n\n⚠️ *Точки роста:*\n• Эмоциональные качели\n• Замкнутость на проблемах\n• Обидчивость\n\n💫 *Совет:*\nРаботайте над эмоциональной устойчивостью. Учитесь выходить из кризисов вместе. 💪"),
            ("Воздух 💨", "Воздух 💨"): (75, 88, "💬 *Воздух + Воздух* — лёгкость и свобода! Вам никогда не бывает скучно вместе. 🦋\n\n💪 *Сильные стороны:*\n• Интеллектуальное взаимопонимание\n• Много общих тем и интересов\n• Лёгкость и свобода\n\n⚠️ *Точки роста:*\n• Недостаток глубины чувств\n• Легкомыслие в обязательствах\n• Избегание серьёзных разговоров\n\n💫 *Совет:*\nНе бойтесь глубины. Открывайте друг другу душу и чувства. 💕"),
            ("Вода 💧", "Воздух 💨"): (65, 80, "🌿 *Вода + Воздух* — интересный союз. Эмоции встречаются с разумом. 🕊️\n\n💪 *Сильные стороны:*\n• Баланс чувств и логики\n• Умение слушать и слышать\n• Интерес к миру друг друга\n\n⚠️ *Точки роста:*\n• Вода слишком эмоциональна для Воздуха\n• Воздух слишком холоден для Воды\n• Непонимание\n\n💫 *Совет:*\nУчитесь принимать различия. Ваша уникальность может стать силой. 🌈")
        }

        key = (elem1, elem2)
        if key not in compat_data:
            key = (elem2, elem1)

        data = compat_data.get(key, compat_data.get(("Огонь 🔥", "Огонь 🔥")))
