...
async def generate_pdf_report(user_id: int, partner_date: str = None) -> io.BytesIO:
    ...
    fate_details = {
        1: "Вы — прирождённый лидер. Вам суждено вести за собой, начинать новое и вдохновлять. Ваша энергия заразительна, а идеи — новаторские. Избегайте одиночества и учитесь делегировать.",
        2: "Вы — дипломат и миротворец. Ваша суперсила — находить общий язык с любым человеком. Вы чувствуете эмоции других и создаёте гармонию там, где хаос. Учитесь говорить «нет».",
        3: "Вы — творец и вдохновитель. Ваша энергия радости заражает всех вокруг. Вам легко даются слова, искусство, коммуникация. Главное — не распыляться и доводить начатое до конца.",
        4: "Вы — строитель и опора. Ваша сила в дисциплине и упорстве. Вы создаёте прочные основы для себя и близких. Главное — не превращаться в трудоголика и уметь отдыхать.",
        5: "Вы — искатель свободы и приключений. Рутина — ваш враг. Вам нужны перемены, путешествия, новые впечатления. Учитесь стабильности в отношениях и финансах.",
        6: "Вы — сердце семьи и опора для близких. Ваша любовь безусловна, забота безгранична. Главное — не забывать о себе и своих желаниях.",
        7: "Вы — исследователь глубин. Вам нужно время для размышлений и одиночества. Ваша интуиция и аналитический ум — главные помощники. Доверяйте себе.",
        8: "Вы — рождены для успеха. Деньги и власть приходят к вам, когда вы в гармонии с собой. Главное — не забывать о духовном развитии.",
        9: "Вы — гуманист и учитель. Ваша миссия — помогать другим и завершать старое, открывая путь новому. Учитесь прощать и отпускать."
    }
    ...
    day_desc = {
        1: "Лидерство, независимость, новаторство. Вы любите начинать новое и не боитесь ответственности. Ваша задача — научиться делегировать.",
        2: "Дипломатичность, сотрудничество, гармония. Вы — командный игрок и отличный партнёр. Учитесь говорить «нет».",
        3: "Творчество, коммуникация, оптимизм. Ваша стихия — самовыражение и радость. Не распыляйтесь.",
        4: "Стабильность, порядок, трудолюбие. Вы — надёжная опора для других. Отдыхайте вовремя.",
        5: "Свобода, перемены, приключения. Рутина — ваш враг. Учитесь стабильности в отношениях.",
        6: "Забота, ответственность, семья. Дом и близкие — ваше всё. Не забывайте о себе.",
        7: "Анализ, мудрость, духовность. Вы — исследователь глубин. Доверяйте интуиции.",
        8: "Успех, власть, материализация. Вы созданы для больших свершений. Не забывайте о духовном.",
        9: "Гуманизм, завершение, прощение. Ваша миссия — помогать. Учитесь отпускать прошлое."
    }
    month_desc = {
        1: "Январь — начало цикла. Вы любите планировать и начинать новое. Ваша энергия обновляется зимой.",
        2: "Февраль — время терпения. Вы умеете ждать и договариваться. Ваша сила в дипломатии.",
        3: "Март — энергия роста. Вы активны и любознательны. Весна — время ваших свершений.",
        4: "Апрель — стабильность. Вы цените порядок и структуру. Ваше время — середина года.",
        5: "Май — свобода. Вы стремитесь к независимости. Лето приносит вам вдохновение.",
        6: "Июнь — гармония. Вы создаёте уют вокруг себя. Осень — время для перемен.",
        7: "Июль — мудрость. Вы любите анализировать и размышлять. Зимой вы набираетесь сил.",
        8: "Август — сила. Вы амбициозны и целеустремлённы. Конец года — время успеха.",
        9: "Сентябрь — завершение. Вы умеете прощать и отпускать. Осень — время подводить итоги.",
        10: "Октябрь — трансформация. Вы легко адаптируетесь к переменам. Ноябрь — время покоя.",
        11: "Ноябрь — духовность. Вы ищете глубинный смысл. Декабрь — время исполнения желаний.",
        12: "Декабрь — итоги. Вы подводите черту и готовитесь к новому. Январь — ваше время."
    }
    year_total = sum(int(d) for d in str(year))
    while year_total > 9:
        year_total = sum(int(d) for d in str(year_total))
    year_desc = {
        1: "Год начинаний — время ставить цели и действовать. Ваши проекты обретут форму.",
        2: "Год сотрудничества — время искать союзников и договариваться. Одиночество не продуктивно.",
        3: "Год творчества — время самовыражения и радости. Займитесь любимым делом.",
        4: "Год труда — время строить основы и работать над планами. Упорство принесёт плоды.",
        5: "Год перемен — время путешествий и новых впечатлений. Не бойтесь выходить из зоны комфорта.",
        6: "Год семьи — время заботы о близких и укрепления связей. Дом — ваша крепость.",
        7: "Год мудрости — время учиться, анализировать и расти духовно. Знания — сила.",
        8: "Год силы — время карьерных достижений и материального роста. Успех придёт.",
        9: "Год завершения — время подводить итоги и освобождать место новому. Отпустите прошлое."
    }
    ...
    love_text = "💕 <b>Любовь и отношения:</b> " + {
        ...
        2: "Год гармонии. Существующие отношения укрепятся, одиноким стоит искать партнёра среди друзей.",
        3: "Год флирта и лёгкости. Не торопитесь с серьёзными обязательствами.",
        4: "Год стабильности. Отношения требуют работы и терпения.",
        5: "Год перемен. Возможны новые романы и яркие встречи.",
        6: "Год семьи. Время укреплять связи с близкими.",
        7: "Год одиночества и самоанализа. Не торопитесь с отношениями.",
        8: "Год страсти. Яркие романы и сильные чувства.",
        9: "Год завершения. Отпустите старые связи, освободите место для нового."
    ...
    career_text = "💼 <b>Карьера и финансы:</b> " + {
        1: "Год новых проектов и стартов. Ваша инициатива будет вознаграждена.",
        2: "Год партнёрств. Работа в команде принесёт больше, чем одиночество.",
        3: "Год творчества. Ищите нестандартные решения и подходы.",
        4: "Год упорного труда. Закладывайте фундамент для будущего успеха.",
        5: "Год перемен. Не бойтесь менять работу или сферу деятельности.",
        6: "Год стабильности. Укрепляйте позиции на текущем месте.",
        7: "Год обучения и поиска. Инвестируйте в свои знания.",
        8: "Год успеха и признания. Возможны повышение и бонусы.",
        9: "Год завершения проектов. Подводите итоги и готовьтесь к новому циклу."
    }.get(total_2026, "Год карьерного роста и финансовой стабильности.")
    story.append(Paragraph(career_text, normal_style))
    story.append(Spacer(1, 0.2*cm))
    
    health_text = "🌸 <b>Здоровье:</b> " + {
        1: "Будьте активны. Спорт и движение — ваше всё.",
        2: "Уделяйте внимание психологическому состоянию. Медитация и отдых важны.",
        3: "Заботьтесь о нервной системе. Избегайте перегрузок.",
        4: "Обратите внимание на питание и режим.",
        5: "Путешествия и смена обстановки пойдут на пользу.",
        6: "Уделяйте время семье и дому — это ваша энергия.",
        7: "Восстанавливайтесь через знания и духовные практики.",
        8: "Следите за спиной и суставами. Умеренные нагрузки.",
        9: "Завершите курсы лечения. Отпустите старые болячки."
    }.get(total_2026, "Год для укрепления здоровья и формирования полезных привычек.")
    ...
    monthly_details = [
        ...
        ("Февраль", "💕 <b>День влюблённых 14.02</b> — время любви и гармонии. Укрепляйте отношения с близкими. Возможны романтические сюрпризы и приятные встречи."),
        ("Март", "🎨 <b>Весеннее равноденствие 20.03</b> — время творчества. Займитесь тем, что приносит радость. Энергия роста, новые проекты и идеи."),
        ("Апрель", "🏗️ <b>Полнолуние 12.04</b> — время подводить итоги. Работайте над долгосрочными проектами. Финансовая стабильность."),
        ("Май", "✈️ <b>Сезон путешествий</b> — время перемен и новых впечатлений. Отличный месяц для поездок и расширения горизонтов."),
        ("Июнь", "🏡 <b>Летнее солнцестояние 21.06</b> — время семьи. Забота о доме и близких принесёт счастье. Укрепление отношений."),
        ("Июль", "📚 <b>Период ретроградности</b> — время учиться и анализировать. Хороший месяц для саморазвития и духовного роста."),
        ("Август", "💼 <b>Время сбора урожая</b> — карьерные успехи и финансовая удача. Признание заслуг и возможные бонусы."),
        ("Сентябрь", "🌅 <b>Осеннее равноденствие 22.09</b> — время завершения. Подводите итоги и готовьтесь к новому циклу."),
        ("Октябрь", "🌟 <b>Начало нового цикла</b> — новые возможности и перспективы. Энергия обновления."),
        ("Ноябрь", "🤝 <b>Период партнёрства</b> — ищите союзников и укрепляйте связи. Удачные переговоры."),
        ("Декабрь", "🎄 <b>Новогодний месяц</b> — время радости, праздников и подведения итогов года. Наслаждайтесь результатами.")
    ]
    ...
    if partner_date:
        ...
        # Добавляем дополнительные разделы совместимости
        story.append(Paragraph("<b>🔮 Совместимость в разных сферах:</b>", heading3_style))
        
        if comp['percent'] >= 85:
            story.append(Paragraph("💕 <b>Любовь и секс:</b> Искра между вами никогда не гаснет. Вы созданы друг для друга.", normal_style))
            story.append(Paragraph("💰 <b>Финансы:</b> Совместные проекты будут успешны. Доверяйте партнёру.", normal_style))
            story.append(Paragraph("🤝 <b>Дружба:</b> Вы не только любовники, но и лучшие друзья.", normal_style))
        elif comp['percent'] >= 70:
            story.append(Paragraph("💕 <b>Любовь и секс:</b> Хорошая совместимость. Есть куда расти, но потенциал огромен.", normal_style))
            story.append(Paragraph("💰 <b>Финансы:</b> При совместной работе можно добиться успеха.", normal_style))
            story.append(Paragraph("🤝 <b>Дружба:</b> У вас общие интересы и ценности.", normal_style))
        else:
            story.append(Paragraph("💕 <b>Любовь и секс:</b> Вы очень разные, но это может быть вашей силой.", normal_style))
            story.append(Paragraph("💰 <b>Финансы:</b> Будьте осторожны с общими деньгами.", normal_style))
            story.append(Paragraph("🤝 <b>Дружба:</b> Учитесь принимать различия — это сделает вас сильнее.", normal_style))
        story.append(Spacer(1, 0.5*cm))
    else:
        story.append(Paragraph("💕 5. АНАЛИЗ СОВМЕСТИМОСТИ", heading1_style))
        story.append(Paragraph("🔓 <b>Полный анализ совместимости доступен по подписке Premium.</b>", normal_style))
    ...
    taro_spreads = [
        ...
        ("2. Что вас ждёт", "Колесница ⚡ — «Время двигаться вперёд, преодолевая препятствия. Успех близок.»"),
        ("3. Испытания", "Звезда ⭐ — «Верьте в лучшее. Вселенная готовит вам подарок.»"),
        ("4. Помощь", "Сила 🦁 — «Внутренняя мощь поведёт вас. Вы сильнее, чем кажетесь.»"),
        ("5. Любовь", "Влюблённые 💕 — «Судьбоносная встреча или важный выбор в отношениях.»"),
        ("6. Карьера", "Император 🏛️ — «Укрепление позиций или повышение. Ваш труд оценят.»"),
        ("7. Финансы", "Десятка Пентаклей 💰 — «Стабильный доход, возможно наследство или крупный подарок.»"),
        ("8. Здоровье", "Умеренность ⚖️ — «Баланс между работой и отдыхом. Не переутомляйтесь.»"),
        ("9. Духовный рост", "Отшельник 🏮 — «Год глубокого самоанализа и поиска истины.»"),
        ("10. Итог года", "Мир 🌍 — «Завершение цикла, достижение цели. Празднуйте победу!»")
    ]
    ...
    affirmations = [
        ...
        "Я благодарна за всё, что имею. Моя жизнь прекрасна.",
        "Я выбираю радость каждый день. Счастье внутри меня.",
        "Я привлекаю нужных людей в свою жизнь.",
        "Моя жизнь наполнена смыслом и любовью.",
        "Я верю в свои силы. Я могу всё.",
        "Я создаю своё счастливое будущее прямо сейчас.",
        "Я достойна успеха и признания. Я ценна."
    ]
    ...
    story.append(Paragraph("🌕 <b>Полнолуние</b> — время подводить итоги, отпускать лишнее, праздновать. <b>Ритуал:</b> Напишите, от чего хотите избавиться, и сожгите.", normal_style))
    ...
    story.append(Paragraph("✨ <b>Не бойтесь просить о помощи, когда она нужна</b> — вы не одиноки. Люди вокруг готовы поддержать.", normal_style))
    story.append(Paragraph("✨ <b>Благодарите себя и других каждый день</b> — благодарность привлекает чудеса. Ведите дневник благодарности.", normal_style))
    story.append(Paragraph("✨ <b>Помните: ваша жизнь — в ваших руках</b>. Меняйте мысли — меняется реальность. Вы — творец своей судьбы.", normal_style))
    story.append(Spacer(1, 0.8*cm))
