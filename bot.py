...
async def pdf_without_partner(callback: types.CallbackQuery, state: FSMContext):
    await callback.answer()
    waiting_msg = await callback.message.answer("📄 Генерирую твой персональный отчёт... Подожди немного ✨")
    ...
    try:
        ...
        await waiting_msg.edit_text("❌ Извините, при генерации отчёта произошла ошибка. Попробуйте ещё раз позже.")
